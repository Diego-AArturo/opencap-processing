...
def generateExternalFunction(
    ...
    print('jointset: ', jointSet.getSize())
    # Filtrar coordenadas solo para pelvis y miembros inferiores
    allowed_coords = ['pelvis_tilt', 'pelvis_list', 'pelvis_rotation',
    ...
    coordinates = [c for c in coordinates if c in allowed_coords]
