...
def IntegrateForcepalte(session_id, trial_name, force_gdrive_url):
    ...
    # force_gdrive_url = 'https://drive.usercontent.google.com/u/2/uc?id=1a7ig-WkmyEOjJx9JLBl_P3p98Pu7Pvhf&export=download'
    ...
    # r_C0_to_forceOrigin_exp_C = {'R': [0,-.191,.083], #original
    #                              'L': [0,-.191,.083]}

    r_C0_to_forceOrigin_exp_C = {'R': [0,-.160,-.520], #modificados reales 0.080
                                'L': [0,-.160,-.520]}
